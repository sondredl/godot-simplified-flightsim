...
func process_physic_frame(delta):
    ...
    if axis_z != 0:
        ...
        aircraft.apply_force(
            force_vector_right,
            thruster_rotated_position_right)
    ...
    if axis_x != 0:
        ...
        aircraft.apply_force(
            force_vector_down,
            thruster_rotated_position_front)
    ...
    if axis_y != 0:
        ...
        # Rudder axis positive turns the plane to left (positive rotation on Y
        # axis)
        aircraft.apply_force(
            force_vector_rleft,
            thruster_rotated_position_rfront)
        aircraft.apply_force(
            force_vector_rright,
            thruster_rotated_position_rback)
